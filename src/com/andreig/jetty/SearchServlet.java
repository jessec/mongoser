...
public class SearchServlet extends SkeletonMongodbServlet {
	 ...
	 * log.fine( "options" );
	 * 
	 * Header h = req.getFirstHeader( "Access-Control-Request-Headers" ); h =
	 * req.getFirstHeader( "Access-Control-Request-Method" ); h =
	 * req.getFirstHeader( "Origin" );
	 * 
	 * res.setHeader( "Access-Control-Allow-Origin", "*" ); res.setHeader(
	 * "Access-Control-Allow-Headers", "authorization" ); res.setHeader(
